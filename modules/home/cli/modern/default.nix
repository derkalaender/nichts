...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    programs = {
      ...
      atuin = enabled // { # Better shell history
      ...
      yazi = enabled // { # Terminal file manager
        enableBashIntegration = true;
        enableFishIntegration = true;
        enableZshIntegration = true;
      };
      yt-dlp = enabled // { # YouTube downloader
        settings = {
          audio-format = "best";
          audio-quality = 0;
          embed-chapters = true;
